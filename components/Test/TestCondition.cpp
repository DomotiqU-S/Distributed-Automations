...
bool TestCondition::TestConditionStringState() {
    ConditionStringState condition_1(this->alias_good, this->attribute_string_good, this->for_short,
                                     this->value_string_good);
    ...
    ConditionStringState condition_2(this->alias_good, this->attribute_string_good, this->for_long,
                                     this->value_string_good);
    DistributedDevice::Instance().TriggerIO(this->attribute_string_good, this->value_string_bad);
    DistributedDevice::Instance().TriggerIO(this->attribute_string_good, this->value_string_good);
...
bool TestCondition::TestConditionNumericState() {
    ConditionNumericState condition_1(this->alias_good, this->attribute_string_good, this->for_short, 0,
    ...
    ConditionNumericState condition_2(this->alias_good, this->attribute_string_good, this->for_long, 0,
                                      this->value_numeric_good * 2);
    DistributedDevice::Instance().TriggerIO(this->attribute_string_good, to_string(this->value_numeric_bad));
    DistributedDevice::Instance().TriggerIO(this->attribute_string_good, to_string(this->value_numeric_good));
    if (condition_2.Verify("")) {
...
bool TestCondition::TestConditionLogical() {
    ...
    auto condition_2 = new ConditionStringState(this->alias_good, this->attribute_string_good, this->for_short,
                                                this->value_string_good);
    ...
    condition_2 = new ConditionStringState(this->alias_good, this->attribute_string_good, this->for_short,
                                           this->value_string_good);
